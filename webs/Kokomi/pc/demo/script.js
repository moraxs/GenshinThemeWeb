...
const LANGUAGES = {
    ...
    "cn": {
        audioList: [
            ...
            "audio/CN_voice/01.mp3",
            "audio/CN_voice/02.mp3",
        ...
        texts: {
            "page-title": "珊瑚宫心海~",
            "doc-title": "心海~",
            "page-descriptions": "给珊瑚宫心海写的小网站，对，就是那个<del>可爱的</del>海祇岛的“现人神巫女”!",
            "counter-descriptions": ["心海瘾已经发作了", "心海瘾已经发作了"],
            "counter-unit": ["", "次"],
            "counter-button": ["呐呐~", "呐呐！"],
            "credits-gif": "鸣谢：Seseren_kr提供的心海GIF图片",
            "footer-repository-text": "本网站的Github仓库在这儿：",
            "footer-repository-text-2": "新海的仓库",
...
function refreshLanguageSelector(selectedLanguage){
    switch (selectedLanguage) {
        case "cn":
            ...
            document.getElementById("lan2").innerHTML = "暂不可用";
            document.getElementById("lan3").innerHTML = "暂不可用";
            break;
        case "ja":
...
function refreshModeSelector(selectedLanguage){
    switch (selectedLanguage) {
        case "cn":
            ...
            document.getElementById("mode2").innerHTML = "暂不可用";
            document.getElementById("mode3").innerHTML = "暂不可用";
            break;
        case "ja":
...
const content = `
<br>
请使用Chrome,via等Chromium内核的浏览器，否则可能会出现显示异常<br>
