...
const LANGUAGES = {
    ...
    "cn": {
        audioList: [
            ...
            "audio/General/06.mp3"
        ],
        texts: {
            "page-title": "瑶瑶 ~",
            "doc-title": "喵~",
            "page-descriptions": "给瑶瑶写的小网站，对，就是那个<del>可爱的</del>白玉萝卜真君!",
            "counter-descriptions": ["瑶瑶已经喵~了", "瑶瑶已经喵了"],
            "counter-unit": ["喵", "喵"],
            "counter-button": ["喵~", "呜！"],
            "credits-gif": "鸣谢：Seseren_kr提供的瑶瑶GIF图片",
            "footer-repository-text": "本网站的Github仓库在这儿：",
            "footer-repository-text-2": "瑶瑶的仓库",
